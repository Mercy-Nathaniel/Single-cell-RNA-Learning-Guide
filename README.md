...
When starting scRNA‑seq analysis, it is easy to feel overwhelmed by:
- Complex documentation
- Unfamiliar data structures
- Too many parameters and options
...
This project focuses on the two most common single-cell analysis tools:

### Scanpy (Python)
- Primary scripting language: Python
- Used for scalable and flexible single-cell analysis
- Learning focus: understanding workflows and core steps

### Seurat (R)
- Used as a conceptual and visualization reference
...
- Beginners learning scRNA‑seq analysis
- Python users new to single-cell data
- Learners who want concept-first explanations
- Anyone who prefers clear steps over dense documentation

No prior experience with single-cell analysis is assumed.
